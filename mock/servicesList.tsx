...
export const servicesList = [
  ...
  },
  {
    name: "Back End",
    description:
      "Desenvolvimento back-end, com expertise em criação de <em>API RESTful</em> utilizando tecnologias como <em>Node</em> e <em>Nest.js</em>, com foco no desenvolvimento back-end, além de <em>Django</em>. Tenho conhecimento em integração com Bancos de Dados <em>SQL</em> e <em>NoSQL</em>, incluindo <em>PostgreSQL</em>, <em>MongoDB</em> e <em>Elasticsearch</em>, garantindo soluções robustas e escaláveis.",
